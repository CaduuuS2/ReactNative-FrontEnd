...
const Cadastro = () => {
    ...
    return (
        <Container>
            ...
            <Subtitulo>CADASTRO. Novo na Amazon?</Subtitulo>
            </Header>
            <Main>
                <ImputView>
                    <TituloImput>Nome e sobrenome</TituloImput>
                    <InputModal
                        placeholder="Nome"
                        value={nome}
                ...
                <ImputView>
                    ...
                    <InputModal
                        ...
                        onChangeText={setEmailOuCelular}
                    />
                </ImputView>
                <ImputView>
                    <TituloImput>Crie uma senha</TituloImput>
                    <InputModal
                        placeholder="Senha"
